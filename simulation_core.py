...
class SimulationCore:
    ...
    def _load_sensors(self, filename):
        ...
        try:
            ...
            print(config.tr("Sensor Load Error", filename, e))
            return []
...
if __name__ == "__main__":
    print(config.tr("Perf Test Start"))
    ...
    print(config.tr("Simulating Days", days_to_simulate, total_steps))
    ...
    print(config.tr("Done"))
    print(config.tr("Execution Time", duration))
    print(config.tr("Speed", fps))
    print(config.tr("Training Time Est", 35040/fps/60))